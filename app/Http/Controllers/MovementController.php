...
class MovementController extends Controller
{
    public function index(StoreRequest $request)
    {
        ...
        if (!$active) {
            $query->addSelect('person_client.name as client_name', 'person_client.document as client_document', 'document_types.code as document_type_code')->leftJoin('clients', 'clients.id', '=', 'movements.client_id')->leftJoin('users as uc', 'uc.id', '=', 'clients.user_id')->leftJoin('people as person_client', 'person_client.id', '=', 'uc.person_id')->leftJoin('document_types', 'document_types.id', '=', 'person_client.document_type_id');
        }
