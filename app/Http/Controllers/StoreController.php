...
class StoreController extends Controller
{
    ...
    public function employee_index(Request $request, Store $store)
    {
    ...
    public function employee_store(Request $request, Store $store)
    {
    ...
    public function employee_destroy($store_id, $user_id)
    {
