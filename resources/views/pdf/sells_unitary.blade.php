    ...
    <table class="table" style="padding-top: 20px;">
        <tbody>
            <tr class="bold fuente12">
                ...
                <td width="30%" class="borde center">Nombre</td>
                <td width="10%" class="borde center">Marca</td>
                <td width="10%" class="borde center">Color</td>
            ...
            <tr class="fuente10">
                ...
                <td class="borde center">{{ $product->brand_name }}</td>
            ...
            @endforeach
            <tr class="fuente10">
                <td colspan="6" class="bold borde right">TOTAL</td>
