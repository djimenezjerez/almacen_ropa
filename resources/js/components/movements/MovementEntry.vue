<template>
  <v-container>
    ...
    <product-selection ref="productSelection" :movementType="movementType" :available="false" v-on:updateList="updateList"/>
  </v-container>
</template>
      ...
      return [
        {
          ...
          text: this.movementType.name,
          disabled: true,
          to: {
            path: `/movements/${this.movementType.code}`,
          },
        },
      ]
    }
