...
export default {
  ...
  methods: {
    ...
    gotoProductSizes(productId) {
      this.$router.push({
        path: this.isBuilding
          ? `/${this.$route.params.storeType}/${this.$route.params.storeId}/products/${this.$route.params.productNameId}/sizes/${productId}`
          : `/products/${this.$route.params.productNameId}/sizes/${productId}`,
        query: {
          size_type_id: this.sizeType.id,
        },
      });
    ...
    async fetchProductName() {
      try {
        let response = await axios.get(
          `product_name/${this.$route.params.productNameId}`,
          {
            params: {
              size_type_id: this.$route.query.size_type_id,
    ...
    async fetchSizeType() {
      try {
        let response = await axios.get(
          `size_type/${this.$route.query.size_type_id}`
        );
    ...
    async fetchProducts() {
      try {
        ...
        let response = await axios.get(
          `product/${this.$route.params.productNameId}`,
          {
            params: {
