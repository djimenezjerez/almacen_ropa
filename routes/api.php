...
Route::group(['middleware' => ['auth:sanctum']], function () {
    ...
    Route::group(['middleware' => ['can:TIENDAS']], function () {
        ...
        Route::post('store/{store}/logo', [StoreController::class, 'logo']);
        Route::post('store/{store}/qr', [StoreController::class, 'qr']);
        // Empleados
    ...
    Route::group(['middleware' => ['can:PRODUCTOS']], function () {
        ...
        Route::post('product/{product}/image', [ProductController::class, 'image']);
